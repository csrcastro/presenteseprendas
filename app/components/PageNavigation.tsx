    ...
    <div className={`${containerClasses} flex items-center justify-between`}>
      <div className="flex flex-1 justify-between sm:hidden">
        <Link
          ...
          className={` pn-l-m text-${textColor} ${
            current === 1
              ? ` opacity-50 pointer-events-none text-${borderColor}`
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-center">
        ...
        >
          {current === 1 ? (
            <span
              className={`pn-l rounded-l-md text-${textColor} ring-${borderColor} opacity-50 pointer-events-none text-${borderColor}`}
            >
          ...
          {current < total ? (
            ...
            <span
              className={`pn-l rounded-r-md text-${textColor} ring-${borderColor} opacity-50 pointer-events-none text-${borderColor}`}
            >
              <span className="sr-only">{"Próximo"}</span>
              <ChevronRightIcon className="h-5 w-5" aria-hidden="true" />
            </span>
