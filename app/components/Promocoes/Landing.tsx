...
import PromocoesGrid from './PromocoesGrid';
    ...
    <main {...storyblokEditable(blok)} key={blok._uid}>
      <section aria-labelledby="Cabeçalho da página de guias">
        <div className="relative overflow-hidden bg-background">
          ...
          >
            <div
              className="to-backround aspect-[1318/752] w-[82.375rem] flex-none bg-gradient-to-r
               from-background to-colder opacity-25"
              style={{
          ...
          <div className="relative mx-auto max-w-3xl px-4">
            <h1 className={`${styles.largeHeading} text-cold`}>{blok.Title}</h1>
            <div className="mb-16">
      ...
      <section className="bg-background">
        <div className="mx-auto px-4 lg:max-w-7xl lg:px-8">
          ...
          <PromocoesGrid promocoes={recent} />
          <div className="mb-16 text-center">
            <button
              className={`${styles.largeButton} ${styles.verMaisButton} 
              mt-16 bg-cold text-white hover:bg-colder hover:text-white`}
              onClick={() => {
                loadMoreRecent();
              }}
            >
